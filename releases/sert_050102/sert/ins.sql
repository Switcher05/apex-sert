...
PROMPT                              
PROMPT  ===================== APEX-SERT =======================
PROMPT  Software Version: 050102
PROMPT
...
define esert_user                  = 'SV_SERT_050102'
...
--  =================
--  ================= Does the SV_SERT_050102 user exist? If not run the Create User Script
--  =================
column create_user new_val create_user_s NOPRINT
--
select 'null.sql' create_user from dba_users where username = upper('SV_SERT_050102');
--
...
set termout off
--
-- Create the SV_SERT_050102 User and it's grants
-- 
define create_user_s               = 'ins/create_user.sql'
...
--
define parse_as_user               = 'SV_SERT_APEX'
...
PROMPT
PROMPT  =============================================================================
PROMPT  == Ready to start SERT Version 050102 installation...
PROMPT  =============================================================================
PROMPT
...
PROMPT 'Connecting to "sv_sert_050102" to create objects.'
...
INSERT INTO sv_sert_050102.sv_sec_snippets (snippet_key, snippet, editable)
...
PROMPT  =============================================================================
alter user sv_sert_050102 account lock;
...
BEGIN 
  dbms_utility.compile_schema(schema => 'SV_SERT_050102');
END;
/
...
set define '^'
BEGIN
  sv_sert_050102.LOGGER_CONFIGURE;
  commit;
END;
/
