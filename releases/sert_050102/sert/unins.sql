...
PROMPT ****   Dropping the SV_SERT_APEX USER
drop user SV_SERT_APEX cascade
/

PROMPT ****   Dropping the SV_SERT_050102 USER
drop user SV_SERT_050102 cascade
/
...
IF l_job_exists = 1 THEN
  dbms_scheduler.drop_job(job_name => 'SV_SERT_050102.SV_SERT_EVAL_JOB');
END IF;
