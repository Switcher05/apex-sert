...
begin
  dbms_scheduler.create_job(
     job_name => 'SV_SERT_050102.LOGGER_PURGE_JOB',
...
PROMPT =================================================================================
PROMPT === This view will install with an error as it depends on logger.date_text_format
PROMPT =================================================================================
...
-- Commented out because of invoker rights and the way it's installed.
-- If we really need it we can fix by connecting directly to the owning schema
